    ...
    <div className=\"space-y-6\">
      <div className=\"flex items-center justify-between\">
        <div>
          ...
          <p className=\"text-gray-600\">Manage courses and time slots</p>
        </div>
      ...
      <div className=\"card\">
        <div className=\"card-body text-center py-12\">
          ...
          <ul className=\"mt-4 text-sm text-gray-600 space-y-1\">
            ...
            <li>• Define time slots (Saturday-Thursday)</li>
            <li>• Assign TAs to courses</li>
            <li>• Set course requirements</li>
          </ul>
        </div>
      </div>
    </div>
